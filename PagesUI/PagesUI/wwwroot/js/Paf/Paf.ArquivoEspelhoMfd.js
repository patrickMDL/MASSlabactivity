function ArquivoEspelhoMfd() {
    var _urlStorageBlob;

    this.SetUrlStorageBlob = function (pUrl) {
        _urlStorageBlob = pUrl;
    },
    this.SaveEspelhoMfdData = function (pUrl, pModel) {
        $.ajax({
            type: "POST",
            url: pUrl,
            ...
            success: function (data) {
                ...
                Core.EnabledButton($("#btnSaveData"));
                Core.EnabledButton($("#btnSaveCoo"));
            }
        });
    },
    ...
    this.GetListEspelhoMfd = function (pUrl, pPg) {
        $.ajax({
            type: "POST",
            url: pUrl,
            content: "application/json; charset=utf-8",
            ...
            success: function (data) {
                if (data.Success) {
                    ArquivoEspelhoMfd.InitializeTableWithExportOptions(data.Model);
        ...
        var settings = {
            ...
            "createdRow": function (row, data, dataIndex) {
                ...
                $('[data-type="info"]', row).click(function (event) {
                    ArquivoEspelhoMfd.GetDetailArquivoEspelhoMfd(data["Id"]);
                });
    ...
    this.GetDetailArquivoEspelhoMfd = function (pId) {
        $.ajax({
            type: "GET",
            url: "/Paf/GetDetail",
            data: {
            ...
            success: function (result) {
                $("#_ArquivoEspelhoMfdDetail").html(result);
                Core.ShowModal($("#_ArquivoEspelhoMfdDetail"));
            },
...
var ArquivoEspelhoMfd = new ArquivoEspelhoMfd();