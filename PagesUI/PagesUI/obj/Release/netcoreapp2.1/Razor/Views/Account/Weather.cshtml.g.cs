#pragma checksum "C:\Users\Patrick\Desktop\MASSlabactivity\PagesUI\PagesUI\Views\Account\Weather.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "ecb29a52dd4d930a8be3b2badf2caad4d2a4e944"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"ecb29a52dd4d930a8be3b2badf2caad4d2a4e944", @"/Views/Account/Weather.cshtml")]
    ...
    public class Views_Account_Weather : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            ...
            EndContext();
            BeginContext(33, 6699, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "8408411eba604a3d8c343025530f159f", async() => {
                BeginContext(39, 6686, true);
                WriteLiteral(@"
...
");
            ...
            EndContext();
            BeginContext(6732, 1, true);
            WriteLiteral("\n");
            EndContext();
            BeginContext(6733, 25319, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "e4ca542460ed4b83b466ab68996da58f", async() => {
                BeginContext(6770, 25275, true);
                WriteLiteral(@"
        ...
        <div class=""sidebar-menu"">
            <div class=""scroll-wrapper menu-items"" style=""position: relative;"">
                <ul class=""menu-items scroll-content"" style=""height: 883px; margin-bottom: 0px; margin-right: 0px; max-height: none;"">
                    ...
                    <li class="""">
                        <a href=""../condensed/soc");
                WriteLiteral(@"ial.html""><span class=""title"">Social</span></a>
           ...
           ");
                WriteLiteral(@"                 </li>
                            <li class="""">
                                <a href=""../condensed/calendar_month.html"">Month</a>
                 ...
                 ");
                WriteLiteral(@"           <span class=""title"">Builder</span>
                        </a>
                    ...
                    <li>
                        ...
                        <ul class=""sub-menu"">
                            ...
                            <li class="""">
                                ...
                                <span class=""icon-thumbnail""><i class=""");
                WriteLiteral(@"pg-icon"">sl</i></span>
                            </li>
                            <li class="""">
                                <a href=""../condensed/boxed_layout.html"">Boxed</a>
                    ...
                    <li>
                        ...
                        <ul class=""sub-menu"">
                            ...
                            <li class="""">
");
                WriteLiteral(@"                                <a href=""vector_map.html"">Vector Maps</a>
                ...
                </ul><div class=""scroll-element scroll-x"" style=""""><div class=""scroll-element_outer""><div class=""scroll-element_size""></div><div class=""scroll-element_track""");
                WriteLiteral(@"></div><div class=""scroll-bar"" style=""width: 96px; left: 0px;""></div></div></div><div class=""scroll-element scroll-y"" style=""""><div class=""scroll-element_outer""><div class=""scroll-element_size""></div><div class=""scroll-element_track""></div><div class=""scroll-bar"" style=""height: 96px;""></div></div></div>
            </div>
                                                    ...
                                                    <div class=""weather-info row"">
                                                        <div class=""col-6 p-r-15"">
                                                            <div class=""row"">
                                                                <div class=""col-lg-12"">
                                            ");
                WriteLiteral(@"                        <p class=""pull-left no-margin hint-text fs-13"">Vento</p>
                                                        ...
                                                        <div class=""col-6 p-l-15"">
                                                            <div class=""row"">
                                                                <div class=""col-lg-12"">
                                                                    ...
                                                                    <p id=""precipitation"" class=""pull-right no-marg");
                WriteLiteral(@"in fs-13"">--</p>
                                                                </div>
                                                            </div>
                                                            <div class=""row"">
                                                                <div class=""col-lg-12"">
                                                            ...
                                                            <div class=""row"">
                                                                <div class=""col-lg-12"">
                                                                    <p class=""pull-left no-margin hint-text fs-13"">Pôr do Sol</");
                WriteLiteral(@"p>
                                                ...
                                                <div class=""row m-t-20 timeslot"">
                                                    ...
                                                    <div class=""col-2 p-t-10 text-center b-r b-dashed b-grey"">
      ");
                WriteLiteral(@"                                                  <p id=""day2date"" class=""small"">--</p>
                    ...
                    ");
                WriteLiteral(@"                                <div class=""col-2 p-t-10 text-center b-r b-dashed b-grey"">
    ...
    <script src=""../plugins/jquery/jq");
                WriteLiteral(@"uery-easy.js"" type=""text/javascript""></script>
    ...
    <script>
     ...
     ");
                WriteLiteral(@"           var timer = timer2.split(':');
                //by parsing integer, I avoid all extra string processing
                var minutes = parseInt(timer[0], 10);
                ...
                WriteLiteral(@"       humidity.html("""");
                        ...
                        sunrise.append(data.forecast.forecastday[0].astro.sunrise);
                        $(""#conditionIcon"").append('<img src=""' + data.current.condition.icon + '""/>');
                        $(""#day1date"").html(data.forecast.forecastday[1].date + '<b");
                WriteLiteral(@"r/>' + '<img src=""' + data.forecast.forecastday[1].day.condition.icon + '""/>');
                        $(""#day1temp"").html(data.forecast.forecastday[1].day.avgtemp_c + '° C');
                        $(""#day2date"").html(data.forecast.forecastday[2].date + '<br/>' + '<img src=""' + data.forecast.forecastday[2].day.condition.icon + '""/>');
                        $(""#day2temp"").html(data.forecast.forecastday[2].day.avgtemp_c + '° C');
                        $(""#day3date"").html(data.forecast.forecastday[3].date + '<br/>' + '<img src=""' + data.forecast.forecastday[3].day.condition.icon + '""/>');
                        ...
                        $(""#day5date"").html(data.forecast.f");
                WriteLiteral(@"orecastday[5].date + '<br/>' + '<img src=""' + data.forecast.forecastday[5].day.condition.icon + '""/>');
                        $(""#day5temp"").html(data.forecast.forecastday[5].day.avgtemp_c + '° C');
                        $(""#day6date"").html(data.forecast.forecastday[6].date + '<br/>' + '<img src=""' + data.forecast.forecastday[6].day.condition.icon + '""/>');
                        $(""#day6temp"").html(data.forecast.forecastday[6].day.avgtemp_c + '° C');
