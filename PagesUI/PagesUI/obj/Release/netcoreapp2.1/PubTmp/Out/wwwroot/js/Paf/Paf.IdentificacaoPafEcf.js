function IdentificacaoPafEcf() {
    ...
    this.SaveIdentificacaoPafEcf = function (pUrl, pModel) {
        $.ajax({
            type: "POST",
            url: pUrl,
            ...
            async: false,
            data: {
                pIdentificacaoPafEcfMirrorModel: pModel
            },
	...
	this.GetListIdentificacaoPafEcf = function (pUrl) {
	    $.ajax({
	        type: "POST",
	        url: pUrl,
	        content: "application/json; charset=utf-8",
	        ...
	        success: function (data) {
	            if (data.Success) {
	                IdentificacaoPafEcf.InitializeTableWithExportOptions(data.Model);
	    ...
	    var settings = {
	        ...
	        "createdRow": function (row, data, dataIndex) {
	            ...
	            $('[data-type="info"]', row).click(function (event) {
	                IdentificacaoPafEcf.GetDetailIdentificacaoPafEcf(data["Id"]);
	            });
	...
	this.GetDetailIdentificacaoPafEcf = function (pId) {
	    $.ajax({
	        type: "GET",
	        url: "/Paf/GetDetailIdentificacaoPafEcf",
	        data: {
	            pId: pId
	        },
	        success: function (result) {
	            $("#_IdentificacaoPafEcfDetail").html(result);
	            Core.ShowModal($("#_IdentificacaoPafEcfDetail"));
	        },
...
var IdentificacaoPafEcf = new IdentificacaoPafEcf();