#pragma checksum "C:\Users\patri\Desktop\MASSlabactivity\PagesUI\PagesUI\Views\Account\Weather.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "6fc1665fe31811a802ba8c5650ce0594168097c6"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"6fc1665fe31811a802ba8c5650ce0594168097c6", @"/Views/Account/Weather.cshtml")]
    ...
    public class Views_Account_Weather : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "6fc1665fe31811a802ba8c5650ce0594168097c63630", async() => {
                WriteLiteral(@"
    ...
    <script src=""../assets/plugins/jquery/jquery-3.2.1.min");
        ...
        $(document).ready(function () {
           ...
           ");
                WriteLiteral(@"         precipitation.append(data.current.precip_mm + ' MM');
                    ...
                    $(""#day3date"").html(data.forecast.forecastday[3].date + '<br/>' + '<img src=""' + data.forecast.forecas");
                WriteLiteral(@"tday[3].day.condition.icon + '""/>');
            ...
            function myTimer() {
             ...
             ");
                ...
                navigator.geolocation.getCurrentPosition(function (position) {
                    var weatherAPI = ""https://api.weatherapi.com/v1/forecast.json?key=5b34aa6378dd4d889bf142611201002&q="" + positio");
                WriteLiteral(@"n.coords.latitude + "","" + position.coords.longitude + ""&days=7"";
                    $.getJSON(weatherAPI, function (data) {
                        var currentLocation = $(""#currentLocation"");
                        var currentTemp = $(""#currentTemp"");
                        var localTime = $(""#localtime"");
    ...
    ");
                WriteLiteral(@"                    localTime.html("""");
                        ...
                        sunset.append(data.forecast.forecastday[0].astro.sunset);
                        sunrise.append(data.forecast.forecastday[0].astro.sunrise);
                        $(""#conditionIcon"").append('<img src=""' + data.current.condi");
                WriteLiteral(@"tion.icon + '""/>');
                        $(""#day1date"").html(data.forecast.forecastday[1].date + '<br/>' + '<img src=""' + data.forecast.forecastday[1].day.condition.icon + '""/>');
                        $(""#day1temp"").html(data.forecast.forecastday[1].day.avgtemp_c + '° C');
                        $(""#day2date"").html(data.forecast.forecastday[2].date + '<br/>' + '<img src=""' + data.forecast.forecastday[2].day.condition.icon + '""/>');
                        $(""#day2temp"").html(data.forecast.forecastday[2].day.avgtemp_c + '° C');
                        ...
                        $(""#day3temp"").html(data.forecast.forecastday[3].day.avgtemp_c + '° C');
                        $(""#day4date"").html(data.forecast.forecastday[4].date + '<br/>' + '<img src=""' + data.forecast.forecastday[4].day.condition.icon + '""/>');
                        $(""#day4temp"").html(data.fore");
                WriteLiteral(@"cast.forecastday[4].day.avgtemp_c + '° C');
                        $(""#day5date"").html(data.forecast.forecastday[5].date + '<br/>' + '<img src=""' + data.forecast.forecastday[5].day.condition.icon + '""/>');
                        $(""#day5temp"").html(data.forecast.forecastday[5].day.avgtemp_c + '° C');
                        $(""#day6date"").html(data.forecast.forecastday[6].date + '<br/>' + '<img src=""' + data.forecast.forecastday[6].day.condition.icon + '""/>');
                        $(""#day6temp"").html(data.forecast.forecastday[6].day.avgtemp_c + '° C');
...
");
            ...
            WriteLiteral("\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "6fc1665fe31811a802ba8c5650ce0594168097c617325", async() => {
                WriteLiteral(@"
    ...
    <nav class=""page-sidebar"" data-pages=""sidebar"">
        ...
        <div class=""sidebar-menu"">
            <div clas");
                WriteLiteral(@"s=""scroll-wrapper menu-items"" style=""position: relative;"">
                <ul class=""menu-items scroll-content scroll-scrolly_visible"" style=""height: auto; margin-bottom: 0px; margin-right: 0px; max-height: 735px;"">
                    <li class=""m-t-20 "">
                        ...
                        <span class=""icon-thumbnail"" style=""background:#0094ff""><i class=""pg-cloud white fa-5x"" style=""icon:auto""></i></span>
                    </li>
                    <li");
                ...
                WriteLiteral(@">
                        ...
                        <span class=""icon-thumbnail""><i class=""pg-pin fa-2x""></i></span>
                    </li>
                </ul><div class=""scroll-element scroll-x scroll-scrolly_visible""");
                BeginWriteAttribute("style", " style=\"", 14397, "\"", 14405, 0);
                EndWriteAttribute();
                ...
                BeginWriteAttribute("style", " style=\"", 14642, "\"", 14650, 0);
                EndWriteAttribute();
    ...
    <div class=""page-container"">
                ...
                WriteLiteral(@"   <div class=""card-title"">
                                ...
                                <div class=""card-body"">
                                    <div class=""p-l-5"">
                                        <div class=""row"">
                                            <d");
                WriteLiteral(@"iv class=""col-lg-12 col-xlg-6"">
                                                        ...
                                                        <div class=""col-6 p-r-15"">
                                                            <div class=""row"">
                                                                <div class=""col-lg-12"">
                                                                    ...
                                                                    <p id=""windSpeed"" class=""pull-right no-margin fs-");
                WriteLiteral(@"13"">--</p>
                                                                </div>
                                                            </div>
                                                            <div class=""row"">
      ...
      ");
                WriteLiteral(@"                                                              <p id=""sunrise"" class=""pull-right no-margin fs-13"">--</p>
                                                                </div>
                                                            </div>
                                                        </div>
  ...
  ");
           ...
           ");
                WriteLiteral(@"                                             <p id=""day5temp"" class=""text-success bold"">--</p>
                                                    </div>
    ...
    <script src=""../assets/plugins/jquery-actual/jquery.ac");
                WriteLiteral(@"tual.min.js""></script>
    ...
    <script src=""../assets/plugins/nvd3/src/models/lineWithFocusChart.js"" type=""t");
                WriteLiteral(@"ext/javascript""></script>
    ...
    <script src=""../pages/js/pages.js""></script><div style=""left: -1000px; overflow: scroll; position: absolute; top: -1000px; border: none; box-sizing: content-box; height: 200px; margin: 0px; padding: 0px; width: 200px;""><div style=""border: none; box-sizing: content-box; height: 200");
                WriteLiteral(@"px; margin: 0px; padding: 0px; width: 200px;""></div></div>
    ...
    <script>
        ...
        function myTimer() {
            ...
            navigator.geolocation.g");
                WriteLiteral(@"etCurrentPosition(function (position) {
                var weatherAPI = ""https://api.weatherapi.com/v1/forecast.json?key=5b34aa6378dd4d889bf142611201002&q="" + position.coords.latitude + "","" + position.coords.longitude + ""&days=7"";
                $.getJSON(weatherAPI, function (data) {
                    var currentLocation = $(""#currentLocation"");
                    var currentTemp = $(""#currentTemp"");
                ...
                WriteLiteral(@");
                    ...
                    sunrise.append(data.forecast.forecastday[0].astro.sunrise);
                    $(""#conditionIcon"").");
                WriteLiteral(@"append('<img src=""' + data.current.condition.icon + '""/>');
                    $(""#day1date"").html(data.forecast.forecastday[1].date + '<br/>' + '<img src=""' + data.forecast.forecastday[1].day.condition.icon + '""/>');
                    $(""#day1temp"").html(data.forecast.forecastday[1].day.avgtemp_c + '° C');
                    $(""#day2date"").html(data.forecast.forecastday[2].date + '<br/>' + '<img src=""' + data.forecast.forecastday[2].day.condition.icon + '""/>');
                    $(""#day2temp"").html(data.forecast.forecastday[2].day.avgtemp_c + '° C');
                    ...
                    $(""#day4date"").html(data.forecast.forecastday[4].date + '<br/>' + '<img src=""' + data.forecast.forecastday[4].day.condition.icon + '""/>');
                    $(""#day4temp"").html(d");
                WriteLiteral(@"ata.forecast.forecastday[4].day.avgtemp_c + '° C');
                    $(""#day5date"").html(data.forecast.forecastday[5].date + '<br/>' + '<img src=""' + data.forecast.forecastday[5].day.condition.icon + '""/>');
                    $(""#day5temp"").html(data.forecast.forecastday[5].day.avgtemp_c + '° C');
                    $(""#day6date"").html(data.forecast.forecastday[6].date + '<br/>' + '<img src=""' + data.forecast.forecastday[6].day.condition.icon + '""/>');
                    $(""#day6temp"").html(data.forecast.forecastday[6].day.avgtemp_c + '° C');
